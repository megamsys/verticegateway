...
class MarketPlaceAddonsSpec extends Specification {
  ...
  case object Post extends Context {
    ...
    protected override def bodyToStick: Option[String] = {
      val config = new MarketPlaceAddonsConfig(new MarketPlaceAddonsConfigDisaster("locations", "appsample1.megam.co", "appsample2.megam.co;appsample3.megam.co"), new MarketPlaceAddonsConfigLoadBalancing("", ""),
                                               new MarketPlaceAddonsConfigAutoScaling("", "", ""), new MarketPlaceAddonsConfigMonitoring("op5"))
      val contentToEncode = "{\"node_id\":\"NOD449467584400588800\",\"node_name\":\"appsample1.megam.co\",\"marketplace_id\":\"tyutyujyt\",\"config\":" + config.json + "}"
