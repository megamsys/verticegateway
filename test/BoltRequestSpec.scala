...
class BoltRequestSpec extends Specification {
  ...
  case object Post extends Context {
    ...
    protected override def bodyToStick: Option[String] = {      
      val contentToEncode = "{\"req_type\":\"NSTART\",\"node_name\":\"todaysample1.megam.co\",\"boltdefns_id\":\"BDF392631536735748096\",\"lc_apply\":\"lc_apply\",\"lc_additional\":\"lc_additional\",\"lc_when\":\"lc_when\"}"                                 
