...
class MarketPlaceSpec extends Specification {
  ...
  case object Post0 extends Context {
    ...
    protected override def bodyToStick: Option[String] = {
      val contentToEncode = new MarketPlaceInput("test-Alfresco", "cattype", "5", "logo.png", "megambox.com", models.tosca.KeyValueList.empty, MarketPlacePlans(scala.collection.immutable.List(new MarketPlacePlan("0", "free")))).json
