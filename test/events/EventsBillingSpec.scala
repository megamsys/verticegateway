...
class EventsBillingSpec extends Specification {

def is =
  "EventsBillingSpec".title ^ end ^ """
EventsBillingSpec is the implementation that calls the megam_play API server with the /events url
""" ^ end ^
    "The Client Should" ^
...
case object List extends Context {
  protected override def urlSuffix: String ="eventsbilling/0"
...
case object Index extends Context {
  protected override def urlSuffix: String ="eventsbilling"
...
case object Get extends Context {
    protected override def urlSuffix: String ="eventsbilling/show/0"
