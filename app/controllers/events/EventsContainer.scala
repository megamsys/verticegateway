  ...
  (Validation.fromTryCatchThrowable[Result,Throwable] {
    reqFunneled match {
      case Success(succ) => {
        ...
        models.events.EventsContainer.create(email, clientAPIBody) match {
          case Success(succ) =>
            Status(CREATED)(
              FunnelResponse(CREATED, "EventsContainer record created successfully.", "Megam::EventsContainer").toJson(true))
          case Failure(err) =>
