...
object EventsStorage extends Controller with controllers.stack.APIAuthElement {
  ...
  (Validation.fromTryCatchThrowable[Result,Throwable] {
    reqFunneled match {
      case Success(succ) => {
        ...
        models.events.EventsStorage.create(email, clientAPIBody) match {
          case Success(succ) =>
            Status(CREATED)(
              FunnelResponse(CREATED, "EventsStorage record created successfully.", "Megam::EventsStorage").toJson(true))
          case Failure(err) =>
