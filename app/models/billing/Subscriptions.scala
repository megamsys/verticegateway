...
object SubscriptionsResult {
  ...
  def fromJson(json: String): Result[SubscriptionsResult] = (Validation.fromTryCatch {
    parse(json)
  } leftMap { t: Throwable =>
...
object Subscriptions {
  ...
  private def mkGunnySack(email: String, input: String): ValidationNel[Throwable, Option[GunnySack]] = {
    ...
    val SubscriptionsInput: ValidationNel[Throwable, SubscriptionsInput] = (Validation.fromTryCatch {
