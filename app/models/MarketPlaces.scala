...
*/
   ...
   val toMap = Map[String, MarketPlaceInput](
"1-Megam-StarterPack-Java" -> MarketPlaceInput("1-Megam-StarterPack-Java", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/java.png", "1-Starter packs", "Java Web Starter"), MarketPlacePlans(List(new MarketPlacePlan("0", "Quickly get started with J2EE Spring framework app and a light-weight database.", "Free", "0.5", "", "Ubuntu 14.04 +"))), "false", "predefnode", "false"),
"2-Megam-StarterPack-Rails" -> MarketPlaceInput("2-Megam-StarterPack-Rails", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/rails.png", "1-Starter packs", "Rails App"), MarketPlacePlans(List(new MarketPlacePlan("0", "Quickly get started with rails app and a light-weight database.", "Free", "0.5", "", "Ubuntu 14.04 +"))), "false", "predefnode", "false"),
...
"6-Megam-platform-Docker" -> MarketPlaceInput("6-Megam-platform-Docker", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/docker.png", "2-Platform", "Container"), MarketPlacePlans(List(new MarketPlacePlan("0", "Docker that automates the deployment of applications inside software containers.", "Free", "0.5", "", "Ubuntu 14.04 +"))), "false", "predefnode", "false"),
//"7-Megam-Runtime-Java" -> MarketPlaceInput("7-Megam-StarterPack-Java", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/java.png", "3-Runtime", "OOP language"), MarketPlacePlans(List(new MarketPlacePlan("0", "Java is a computer programming language that is concurrent, class-based, object-oriented, and specifically designed to have as few implementation dependencies as possible.", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
//"8-Megam-Runtime-Rails" -> MarketPlaceInput("8-Megam-StarterPack-Rails", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/rails.png", "3-Runtime", "Web application framework"), MarketPlacePlans(List(new MarketPlacePlan("0", "Ruby on Rails, or simply Rails, is an open source web application framework written in Ruby. Rails is a full-stack framework that emphasizes the use of well-known software engineering patterns and paradigms, including convention over configuration (CoC), don't repeat yourself (DRY), the active record pattern, and model–view–controller (MVC).", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
//"9-Megam-Runtime-Play" -> MarketPlaceInput("9-Megam-StarterPack-Play", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/play.png", "3-Runtime", "Open-source toolkit"), MarketPlacePlans(List(new MarketPlacePlan("0", "Play is an open source web application framework, written in Scala and Java, which follows the model–view–controller (MVC) architectural pattern.", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
//"10-Megam-Runtime-Akka" -> MarketPlaceInput("10-Megam-StarterPack-Akka", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/akka.png", "3-Runtime", "Open-source toolkit"), MarketPlacePlans(List(new MarketPlacePlan("0", "Akka is an open-source toolkit and runtime simplifying the construction of concurrent and distributed applications on the JVM. Akka supports multiple programming models for concurrency, but it emphasizes actor-based concurrency, with inspiration drawn from Erlang.", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
//"11-Megam-Runtime-Nodejs" -> MarketPlaceInput("11-Megam-StarterPack-Nodejs", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/nodejs.png", "3-Runtime", "Cross-platform runtime environment"), MarketPlacePlans(List(new MarketPlacePlan("0", "Node.js is a cross-platform runtime environment for server-side and networking applications. Node.js applications are written in JavaScript, and can be run within the Node.js runtime on OS X, Microsoft Windows and Linux with no changes.", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
