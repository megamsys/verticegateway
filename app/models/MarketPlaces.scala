...
case class MarketPlaceInput(name: String, appdetails: MarketPlaceAppDetails, pricetype: String, features: MarketPlaceFeatures, plan: MarketPlacePlan, attach: String, predefnode: String, approved: String) {
  val json = "{\"name\":\"" + name + "\",\"appdetails\":{" + appdetails.json + "},\"pricetype\":\"" + pricetype + "\",\"features\":{" + features.json + "},\"plan\":{" + plan.json + "},\"attach\":\"" + attach + "\",\"predefnode\":\"" + predefnode + "\",\"approved\":\"" + approved + "\"}"
}
...
object MarketPlaceInput {
  ...
  val toMap = Map[String, MarketPlaceInput](
    "alfresco" -> MarketPlaceInput("alfresco", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/alfresco.png", "ECM", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 alfresco app", "free"), "false", "predefnode", "false"),
    "diaspora" -> MarketPlaceInput("diaspora", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/diaspora.png", "Social", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 diaspora app", "free"), "false", "predefnode", "false"),
    "dokuwiki" -> MarketPlaceInput("dokuwiki", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/dokuwiki.png", "Wiki", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 dokuwiki app", "free"), "false", "predefnode", "false"),
    "drbd" -> MarketPlaceInput("drbd", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/drbd.png", "DR", "2:8.4.3-0ubuntu1", "The Distributed Replicated Block Device (DRBD) is a distributed replicated storage system for the Linux platform. It is implemented as several userspace management applications and some shell scripts and is normally used on high availability (HA) computer clusters."), "free", new MarketPlaceFeatures("May be used to add redundancy to existing deployments. Fully synchronous, memory synchronous or asynchronous modes of operation. Masking of local IO errors. Shared secret to authenticate the peer upon connect. Bandwidth of background resynchronization tunable.", "Automatic recovery after node, network, or disk failures. Efficient resynchronization, only blocks that were modified during the outage of a node. Short resynchronization time after the crash of an active node, independent of the device size. Automatic detection of the most up-to-date data after complete failure", "Integration scripts for use with Heartbeat. Dependencies to serialize resynchronization, in case of default all devices in parallel. Heartbeat integration to outdate peers with broken replication links, avoids switchovers to stale data. Many tuning parameters allow to optimize DRBD for specific machines, networking hardware, and storage subsystem.", "Existing file systems can be integrated into new DRBD setups without the need of copying. Support for compression of the bitmap exchange. Supports single block device sizes of up to one petabyte. Optional load balancing of read requests."), new MarketPlacePlan("0", "Disaster recovery for 1 app or service", "free"), "true", "predefnode", "true"),
    "dreamfactory" -> MarketPlaceInput("dreamfactory", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/dreamfactory.png", "MobileDevelopment", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 dreamfactory app", "free"), "false", "predefnode", "false"),
    "drupal" -> MarketPlaceInput("drupal", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/drupal.png", "CMS", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 drupal app", "free"), "false", "predefnode", "false"),
    "elgg" -> MarketPlaceInput("elgg", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/elgg.png", "Social", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 elgg app", "free"), "false", "predefnode", "false"),
    "firepad" -> MarketPlaceInput("firepad", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/firepad.png", "CloudEditor", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 firepad app", "free"), "false", "predefnode", "false"),
    "ghost" -> MarketPlaceInput("ghost", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/ghost.png", "Blog", "v0.4.1", "Ghost is an Open Source application which allows you to write and publish your own blog, giving you the tools to make it easy and even fun to do. It's simple, elegant, and designed so that you can spend less time making your blog work and more time blogging."), "free", new MarketPlaceFeatures("Ghost is an Open Source application which allows you to write and publish your own blog, giving you the tools to make it easy and even fun to do. It's simple, elegant, and designed so that you can spend less time making your blog work and more time blogging.", "Never stop writing, format on the fly. No messing around with *buttons* everywhere. No writing repetitive HTML markup. Mobile friendly.", "Ghost grabs all the important data about your blog and pulls it into one place. No more clicking through tens of browser tabs to view your traffic, social media subscriptions, content performance or news feeds.", "You can write themes for it so your blog can have its own design. You can write plugins for it to add your own functionality. You can host it on your laptop, or you can host it on a public server. The code is open, and so is the MIT license. No restrictions."), new MarketPlacePlan("0", "create 1 ghost app", "free"), "false", "predefnode", "true"),
    "gitlab" -> MarketPlaceInput("gitlab", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/gitlab.png", "ContinuousIntegration", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 gitlab app", "free"), "false", "predefnode", "false"),
    "hadoop" -> MarketPlaceInput("hadoop", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/hadoop.png", "BusinessIntelligence", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 hadoop app", "free"), "false", "predefnode", "false"),
    "jenkins" -> MarketPlaceInput("jenkins", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/jenkins.png", "ContinuousIntegration", "1.554", "In a nutshell Jenkins CI is the leading open-source continuous integration server. Built with Java, it provides 886 plugins to support building and testing virtually any project."), "free", new MarketPlaceFeatures("Easy installation: Just java -jar jenkins.war, or deploy it in a servlet container. No additional install, no database. Easy configuration: Jenkins can be configured entirely from its friendly web GUI with extensive on-the-fly error checks and inline help. There's no need to tweak XML manually anymore, although if you'd like to do so, you can do that, too. Change set support: Jenkins can generate a list of changes made into the build from Subversion/CVS. This is also done in a fairly efficient fashion, to reduce the load on the repository.", "Jenkins gives you clean readable URLs for most of its pages, including some permalinks like 'latest build' / 'latest successful build', so that they can be easily linked from elsewhere. Monitor build results by RSS or e-mail to get real-time notifications on failures. Builds can be tagged long after builds are completed.", "JUnit test reports can be tabulated, summarized, and displayed with history information, such as when it started breaking, etc. History trend is plotted into a graph. Jenkins can distribute build/test loads to multiple computers. This lets you get the most out of those idle workstations sitting beneath developers' desks.", "Jenkins can keep track of which build produced which jars, and which build is using which version of jars, and so on. This works even for jars that are produced outside Jenkins, and is ideal for projects to track dependency. Jenkins can be extended via 3rd party plugins. You can write plugins to make Jenkins support tools/processes that your team uses."), new MarketPlacePlan("0", "Use 1 continous integration engine", "free"), "true", "predefnode", "true"),
    "joomla" -> MarketPlaceInput("joomla", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/joomla.png", "CMS", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 joomla app", "free"), "false", "predefnode", "false"),
    "liferay" -> MarketPlaceInput("liferay", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/liferay.png", "Collaboration", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 liferay app", "free"), "false", "predefnode", "false"),
    "magneto" -> MarketPlaceInput("magneto", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/magneto.png", "e-Commerce", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 magneto app", "free"), "false", "predefnode", "false"),
    "mediawiki" -> MarketPlaceInput("mediawiki", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/mediawiki.png", "Wiki", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 mediawiki app", "free"), "false", "predefnode", "false"),
    "openam" -> MarketPlaceInput("openam", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openam.png", "AM", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 openam app", "free"), "false", "predefnode", "false"),
    "openatrium" -> MarketPlaceInput("openatrium", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openatrium.png", "ProjectManagement", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 openatrium app", "free"), "false", "predefnode", "false"),
    "opendj" -> MarketPlaceInput("opendj", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/opendj.png", "AM", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 opendj app", "free"), "false", "predefnode", "false"),
    "openerp" -> MarketPlaceInput("openerp", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openerp.png", "ERP", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 openerp app", "free"), "false", "predefnode", "false"),
    "openldap" -> MarketPlaceInput("openldap", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openldap.png", "DirectoryServices", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 openldap app", "free"), "false", "predefnode", "false"),
    "otrs" -> MarketPlaceInput("otrs", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/otrs.png", "HelpDesk", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 otrs app", "free"), "false", "predefnode", "false"),
    "owncloud" -> MarketPlaceInput("owncloud", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/owncloud.png", "Mediasharing", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 owncloud app", "free"), "false", "predefnode", "false"),
    "redmine" -> MarketPlaceInput("redmine", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/redmine.png", "Collaboration", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 redmine app", "free"), "false", "predefnode", "false"),
    "reviewboard" -> MarketPlaceInput("reviewboard", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/reviewboard.png", "Collaboration", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 reviewboard app", "free"), "false", "predefnode", "false"),
    "riak" -> MarketPlaceInput("riak", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/riak.png", "DB", "2.0.0", "Riak is a distributed database designed to deliver maximum data availability by distributing data across multiple servers."), "free", new MarketPlaceFeatures("Riak replicates and retrieves data intelligently so it is available for read and write operations, even in failure conditions. You can lose access to many nodes due to network partition or hardware failure without losing data. Add new machines to your Riak cluster easily without incurring a larger operational burden – the same ops tasks apply to small clusters as large clusters.", "Riak automatically distributes data around the cluster and yields a near-linear performance increase as you add capacity. Use Riak’s distributed, full-text search engine with a robust query language. Tag objects stored in Riak with additional values and query by exact match or range.", "Non-key-based querying for large datasets.Data is distributed across nodes using consistent hashing. Consistent hashing ensures data is evenly distributed around the cluster and new nodes can be added automatically, with minimal reshuffling. Riak uses Folsom, an Erlang-based system that collects and reports real-time metrics, to provide stats via HTTP request.", ""), new MarketPlacePlan("0", "Create 1 database", "free"), "true", "predefnode", "true"),
    "scmmanager" -> MarketPlaceInput("scmmanager", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/scmmanager.png", "DevelopmentPlatform", "1.36", "The easiest way to share and manage your Git, Mercurial and Subversion repositories over http."), "free", new MarketPlaceFeatures("Very easy installation. No need to hack configuration files, SCM-Manager is completely configureable from its Web-Interface. No Apache and no database installation is required. Central user, group and permission management.", "Out of the box support for Git, Mercurial and Subversion. Full RESTFul Web Service API (JSON and XML). Rich User Interface. Simple Plugin API. Useful plugins available (f.e. Ldap-, ActiveDirectory-, PAM-Authentication).", "", ""), new MarketPlacePlan("0", "Create 1 scm-manager app", "free"), "true", "predefnode", "true"),
    "sugarcrm" -> MarketPlaceInput("sugarcrm", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/sugarcrm.png", "CRM", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 sugarcrm app", "free"), "false", "predefnode", "false"),
    "thinkup" -> MarketPlaceInput("thinkup", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/thinkup.png", "Social", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 thinkup app", "free"), "false", "predefnode", "false"),
    "trac" -> MarketPlaceInput("trac", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/trac.png", "BugTracking", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 trac app", "free"), "false", "predefnode", "false"),
    "twiki" -> MarketPlaceInput("twiki", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/twiki.png", "Wiki", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 twiki app", "free"), "false", "predefnode", "false"),
    "wordpress" -> MarketPlaceInput("wordpress", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/wordpress.png", "CMS", "3.8.1", "WordPress is web software you can use to create a beautiful website or blog. We like to say that WordPress is both free and priceless at the same time."), "free", new MarketPlaceFeatures("Start a blog or build a full-fledged website. The only limit is your imagination. Build a great site and spend nothing, zilch, nada. And if you want to make a great site even better, we offer a great selection of premium upgrades. Share your work with the world.", "Publicize lets you connect your WordPress site to the most popular social networks — Facebook, Twitter, Tumblr, LinkedIn, and more. Learn more about your readers, where they’re from, and how they found you. Maps and graphs that beautifully present your stats. Don’t be confined to the desk. Publish near and far with mobile apps for iPhone, iPad, Android, and BlackBerry.", "Your site is hosted on our servers spread across multiple data centers. That way, it’s super fast and always available. Our dashboard is available in over 50 languages and counting.", "Whether you’re searching the forums, reading our support pages, or chatting with a Happiness Engineer, you can always find a helping hand. Keep track of all your favorite blogs and discover new ones with the Reader."), new MarketPlacePlan("0", "Create 1 wordpress app", "free"), "true", "predefnode", "true"),
    "xwiki" -> MarketPlaceInput("xwiki", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/xwiki.png", "Wiki", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 xwiki app", "free"), "false", "predefnode", "false"),
    "zarafa" -> MarketPlaceInput("zarafa", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/zarafa.png", "Firewall", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 zarafa app", "free"), "false", "predefnode", "false")
  )
...
case class MarketPlaceResult(id: String, name: String, appdetails: MarketPlaceAppDetails, pricetype: String, features: MarketPlaceFeatures, plan: MarketPlacePlan, attach: String, predefnode: String, approved: String, created_at: String) {
...
object MarketPlaces {
  ...
  private def mkGunnySack(email: String, input: String): ValidationNel[Throwable, Option[GunnySack]] = {
    ...
    for {
      ...
      val json = new MarketPlaceResult(uir.get._1 + uir.get._2, mkp.name, mkp.appdetails, mkp.pricetype, mkp.features, mkp.plan, mkp.attach, mkp.predefnode, mkp.approved, Time.now.toString).toJson(false)
  ...
  private def mkGunnySack_init(input: MarketPlaceInput): ValidationNel[Throwable, Option[GunnySack]] = {
    ...
    for {
      ...
      val bvalue = Set(mkp.name)
      val mkpJson = new MarketPlaceResult(uir.get._1 + uir.get._2, mkp.name, mkp.appdetails, mkp.pricetype, mkp.features, mkp.plan, mkp.attach, mkp.predefnode, mkp.approved, Time.now.toString).toJson(false)
            ...
            flatMap { maybeGS: Option[GunnySack] =>
              maybeGS match {
                ...
                case None => {
                  ...
                  MarketPlaceResults(MarketPlaceResult(new String(), p._2.name, p._2.appdetails, p._2.pricetype, p._2.features, p._2.plan, p._2.attach, p._2.predefnode, p._2.approved, new String())).successNel[Throwable]
                }
              }
            }
        }
