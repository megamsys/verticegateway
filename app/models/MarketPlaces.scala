...
object MarketPlaceInput {
  ...
  val toMap = Map[String, MarketPlaceInput](
    ...
    "Ghost" -> MarketPlaceInput("Ghost", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/ghost.png", "Blog", "0.4.1", "<h5><dfn>Ghost is an <em>Open Source</em> application which allows you to write and publish your own blog, giving you the tools to make it easy and even fun to do.</h5></dfn>"), "free", new MarketPlaceFeatures("Ghost has an incredibly simple concept for writing. You write in Markdown on the left, and you see an immediate preview of exactly what your post will look like in rendered HTML on the right", "The Ghost Open Marketplace contains a large directory of themes, apps, and resources which have been created for Ghost.", "Drag and drop the widgets to create your own custom dashboard, with the most important information first.",""), new MarketPlacePlan("0", "create 1 ghost app", "free"), new MarketPlaceAppLinks("https://ghost.org/forum/", "#", "https://ghost.org/", "https://ghost.org/features/", "https://ghost.org/about/", "http://en.wikipedia.org/wiki/Ghost_(blogging_platform)", "https://github.com/tryghost/Ghost"), "false", "predefnode", "true"),
    ...
    "SCM-Manager" -> MarketPlaceInput("SCM-Manager", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/scmmanager.png", "DevelopmentPlatform", "1.36", "<h5><dfn>The easiest way to share and manage your <span class='label label-info'>Git, Mercurial and Subversion</span> repositories over http.</h5></dfn>"), "free", new MarketPlaceFeatures("SCM-Manager is completely configureable from its Web-Interface. No Apache and no database installation is required. Central user, group and permission management.", "Out of the box support for Git, Mercurial and Subversion. Full RESTFul Web Service API (JSON and XML). Rich User Interface.", "Trigger builds directly to cloud using scm-megam plugin", ""), new MarketPlacePlan("0", "Create 1 scm-manager app", "free"), new MarketPlaceAppLinks("https://www.scm-manager.com/support/", "https://www.scm-manager.com/support/", "https://www.scm-manager.com/", "https://www.scm-manager.com/scm-manager/", "http://www.scm-manager.org/", "https://bitbucket.org/sdorra/scm-manager/wiki/Home", "https://bitbucket.org/sdorra/scm-manager/src"), "false", "predefnode", "true"),
