...
*/
   ...
   val toMap = Map[String, MarketPlaceInput](
"1-Megam-StarterPack-Java" -> MarketPlaceInput("1-Megam-StarterPack-Java", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/java.png", "1-Starter packs", "OOP language"), MarketPlacePlans(List(new MarketPlacePlan("0", "Java is a computer programming language that is concurrent, class-based, object-oriented, and specifically designed to have as few implementation dependencies as possible.", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
"2-Megam-StarterPack-Rails" -> MarketPlaceInput("2-Megam-StarterPack-Rails", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/rails.png", "1-Starter packs", "Web application framework"), MarketPlacePlans(List(new MarketPlacePlan("0", "Ruby on Rails, or simply Rails, is an open source web application framework written in Ruby. Rails is a full-stack framework that emphasizes the use of well-known software engineering patterns and paradigms, including convention over configuration (CoC), don't repeat yourself (DRY), the active record pattern, and model–view–controller (MVC).", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
...
"7-Megam-StarterPack-Java" -> MarketPlaceInput("7-Megam-StarterPack-Java", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/java.png", "3-Runtime", "OOP language"), MarketPlacePlans(List(new MarketPlacePlan("0", "Java is a computer programming language that is concurrent, class-based, object-oriented, and specifically designed to have as few implementation dependencies as possible.", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
"8-Megam-StarterPack-Rails" -> MarketPlaceInput("8-Megam-StarterPack-Rails", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/rails.png", "3-Runtime", "Web application framework"), MarketPlacePlans(List(new MarketPlacePlan("0", "Ruby on Rails, or simply Rails, is an open source web application framework written in Ruby. Rails is a full-stack framework that emphasizes the use of well-known software engineering patterns and paradigms, including convention over configuration (CoC), don't repeat yourself (DRY), the active record pattern, and model–view–controller (MVC).", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
...
"12-Megam-AppBoilers-PostgreSQL" -> MarketPlaceInput("12-Megam-AppBoilers-PostgreSQL", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/postgres.png", "4-App Boilers", "Object-relational DBMS"), MarketPlacePlans(List(new MarketPlacePlan("0", "PostgreSQL is a powerful, open source object-relational database system. It has more than 15 years of active development and a proven architecture that has earned it a strong reputation for reliability, data integrity, and correctness. ", "Free", "9.1", "", "Ubuntu 13.04 +"))), "false", "predefnode", "true"),
...
"15-Megam-AppBoilers-RabbitMQ" -> MarketPlaceInput("15-Megam-AppBoilers-RabbitMQ", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/rabbitmq.png", "4-App Boilers", "Message broker software "), MarketPlacePlans(List(new MarketPlacePlan("0", "RabbitMQ is open source message broker software (sometimes called message-oriented middleware) that implements the Advanced Message Queuing Protocol (AMQP).", "Free", "2.8.6", "", "Ubuntu 13.04 +"))), "false", "predefnode", "true")
)
