...
*/
   ...
   val toMap = Map[String, MarketPlaceInput](
"1-Megam-StarterPack-Ubuntu" -> MarketPlaceInput("1-Megam-StarterPack-Ubuntu", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/ubuntu.png", "1-Instance", "Ubuntu Server"), MarketPlacePlans(List(new MarketPlacePlan("0", "Ubuntu 12.04 LTS (Precise Pangolin) is the Ubuntu's sixteenth release and its fourth Long Term Support (LTS) release.", "Free", "12.04", "", "Ubuntu 12.04 +"), new MarketPlacePlan("0", "Shuttleworth indicated that the focus in this development cycle would be a release characterized by 'performance, refinement, maintainability, technical debt' and encouraged the developers to make conservative choices.", "Free", "14.04", "", "Ubuntu 14.04 +"))), "false", "predefnode", "false"),
"2-Megam-StarterPack-CoreOS" -> MarketPlaceInput("2-Megam-StarterPack-CoreOS", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/coreos.png", "1-Instance", "CoreOS"), MarketPlacePlans(List(new MarketPlacePlan("0", "CoreOS provides no package manager as a way for the distribution of applications, requiring instead all applications to run inside their containers.", "Free", "633.1.0", "", "CoreOS 633.1.0"))), "false", "predefnode", "false"),
"3-Megam-StarterPack-Debian" -> MarketPlaceInput("3-Megam-StarterPack-Debian", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/debian.png", "1-Instance", "Debian"), MarketPlacePlans(List(new MarketPlacePlan("0", "Debian wheezy.", "Free", "7", "", "Debian wheezy"), new MarketPlacePlan("0", "Debian Jessie.", "Free", "8", "", "Debian Jessie"))), "false", "predefnode", "false"),
"4-Megam-StarterPack-CentOS" -> MarketPlaceInput("4-Megam-StarterPack-CentOS", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/centos.png", "1-Instance", "CentOS"), MarketPlacePlans(List(new MarketPlacePlan("0", "CentOS is an Enterprise-class Linux Distribution derived from sources freely provided to the public by Red Hat.", "Free", "7", "", "CentOS 7"))), "false", "predefnode", "false"),
"5-Megam-StarterPack-Java" -> MarketPlaceInput("5-Megam-StarterPack-Java", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/java.png", "2-Starter packs", "Java Web Starter"), MarketPlacePlans(List(new MarketPlacePlan("0", "Quickly get started with J2EE Spring framework app and a light-weight database.", "Free", "0.5", "", "Ubuntu 14.04 +"))), "false", "predefnode", "false"),
"6-Megam-StarterPack-Rails" -> MarketPlaceInput("6-Megam-StarterPack-Rails", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/rails.png", "2-Starter packs", "Rails App"), MarketPlacePlans(List(new MarketPlacePlan("0", "Quickly get started with rails app and a light-weight database.", "Free", "0.5", "", "Ubuntu 14.04 +"))), "false", "predefnode", "false"),
"7-Megam-StarterPack-Play" -> MarketPlaceInput("7-Megam-StarterPack-Play", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/play.png", "2-Starter packs", "RESTful API Server"), MarketPlacePlans(List(new MarketPlacePlan("0", "Build robust RESTful API server using NoSQL(Riak).", "Free", "0.5", "", "Ubuntu 14.04 +"))), "false", "predefnode", "false"),
"8-Megam-StarterPack-Akka" -> MarketPlaceInput("8-Megam-StarterPack-Akka", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/akka.png", "2-Starter packs", "Clustered HA Daemon"), MarketPlacePlans(List(new MarketPlacePlan("0", "Build powerful concurrent & distributed applications more easily with messaging.", "Free", "0.5", "", "Ubuntu 14.04 +"))), "false", "predefnode", "false"),
"9-Megam-StarterPack-Nodejs" -> MarketPlaceInput("9-Megam-StarterPack-Nodejs", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/nodejs.png", "2-Starter packs", "Realtime App"), MarketPlacePlans(List(new MarketPlacePlan("0", "Build fast, scalable, and incredibly efficient blogging platform with light weight database.", "Free", "0.5", "", "Ubuntu 14.04 +"))), "false", "predefnode", "false"),
"10-Megam-StarterPack-Byoc" -> MarketPlaceInput("10-Megam-StarterPack-Byoc", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/byoc.png", "2-Starter packs", "Bring your own code"), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "0.5", "", "Ubuntu 14.04 +"))), "false", "predefnode", "false"),
"11-Megam-platform-Docker" -> MarketPlaceInput("11-Megam-platform-Docker", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/docker.png", "3-Platform", "Container"), MarketPlacePlans(List(new MarketPlacePlan("0", "Docker that automates the deployment of applications inside software containers.", "Free", "0.5", "", "Ubuntu 14.04 +"))), "false", "predefnode", "false"),
...
MarketPlacePlans(List(new MarketPlacePlan("0", "Riak is a distributed database designed to deliver maximum data availability by distributing data across multiple servers.", "Free", "1.4.8", "https://s3-ap-southeast-1.amazonaws.com/megampub/marketplace/riak/riak_1.4.8-1_amd64.deb", "Ubuntu 14.04 +"), new MarketPlacePlan("0", "Riak is a distributed database designed to deliver maximum data availability by distributing data across multiple servers.", "Free", "2.0.1", "https://s3-ap-southeast-1.amazonaws.com/megampub/marketplace/riak/riak_2.0.1-1_amd64.deb", "Ubuntu 14.04 +"))), "false", "predefnode", "true"),
"14-Megam-AppBoilers-Redis" -> MarketPlaceInput("14-Megam-AppBoilers-Redis", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/redis.png", "4-App Boilers", "Key Value Store"), MarketPlacePlans(List(new MarketPlacePlan("0", "Redis is a key-value store which acts as a data structure server with keys containing strings, hashes, lists, sets and sorted sets.", "Free", "2.8.4", "", "Ubuntu 14.04 +"))), "false", "predefnode", "true"),
"15-Megam-AppBoilers-RabbitMQ" -> MarketPlaceInput("15-Megam-AppBoilers-RabbitMQ", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/rabbitmq.png", "4-App Boilers", "Message Broker"), MarketPlacePlans(List(new MarketPlacePlan("0", "RabbitMQ is a message broker software  that implements the Advanced Message Queuing Protocol (AMQP).", "Free", "3.3.5", "", "Ubuntu 14.04 +"))), "false", "predefnode", "true"),
"16-Megam-Analytics-Hadoop" -> MarketPlaceInput("16-Megam-Analytics-Hadoop", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/hadoop.png", "5-Analytics", "Plumbing your big data is easy"), MarketPlacePlans(List(new MarketPlacePlan("0", "Apache Hadoop is a set of algorithms (an open-source software framework) for distributed storage and distributed processing of very large data sets (Big Data) on computer clusters built from commodity hardware", "Free", "2.6.0", "", "Ubuntu 14.04 +"))), "false", "predefnode", "true")
)
