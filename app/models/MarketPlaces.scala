...
case class MarketPlaceInput(name: String, appdetails: MarketPlaceAppDetails, plans: models.MarketPlacePlans, attach: String, predefnode: String, approved: String) {
  val json = "{\"name\":\"" + name + "\",\"appdetails\":{" + appdetails.json + "},\"plans\":" + MarketPlacePlans.toJson(plans, true) + ",\"attach\":\"" + attach + "\",\"predefnode\":\"" + predefnode + "\",\"approved\":\"" + approved + "\"}"
}
...
*/
   ...
   val toMap = Map[String, MarketPlaceInput](
    "1-Megam-StarterPack-Java" -> MarketPlaceInput("1-Megam-StarterPack-Java", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/java.png", "1-starterpack", "Java is a computer programming language that is concurrent, class-based, object-oriented, and specifically designed to have as few implementation dependencies as possible."), MarketPlacePlans(List(new MarketPlacePlan("0", "object-oriented programming language", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "2-Megam-StarterPack-Rails" -> MarketPlaceInput("2-Megam-StarterPack-Rails", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/rails.png", "1-starterpack", "Ruby on Rails, or simply Rails, is an open source web application framework written in Ruby. Rails is a full-stack framework that emphasizes the use of well-known software engineering patterns and paradigms, including convention over configuration (CoC), don't repeat yourself (DRY), the active record pattern, and model–view–controller (MVC)."), MarketPlacePlans(List(new MarketPlacePlan("0", "open source web application framework", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "3-Megam-StarterPack-Play" -> MarketPlaceInput("3-Megam-StarterPack-Play", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/play.png", "1-starterpack", "Play is an open source web application framework, written in Scala and Java, which follows the model–view–controller (MVC) architectural pattern."), MarketPlacePlans(List(new MarketPlacePlan("0", "open-source toolkit", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "4-Megam-StarterPack-Akka" -> MarketPlaceInput("4-Megam-StarterPack-Akka", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/akka.png", "1-starterpack", "Akka is an open-source toolkit and runtime simplifying the construction of concurrent and distributed applications on the JVM. Akka supports multiple programming models for concurrency, but it emphasizes actor-based concurrency, with inspiration drawn from Erlang."), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "5-Megam-StarterPack-Nodejs" -> MarketPlaceInput("5-Megam-StarterPack-Nodejs", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/nodejs.png", "1-starterpack", "Node.js is a cross-platform runtime environment for server-side and networking applications. Node.js applications are written in JavaScript, and can be run within the Node.js runtime on OS X, Microsoft Windows and Linux with no changes."), MarketPlacePlans(List(new MarketPlacePlan("0", "cross-platform runtime environment", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "6-Megam-platform-Docker" -> MarketPlaceInput("6-Megam-platform-Docker", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/docker.png", "2-platform", "Docker is an open-source project that automates the deployment of applications inside software containers, by providing an additional layer of abstraction and automation of operating system–level virtualization on Linux."), MarketPlacePlans(List(new MarketPlacePlan("0", "virtual container", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "7-Megam-AppBoilers-PostgreSQL" -> MarketPlaceInput("7-Megam-AppBoilers-PostgreSQL", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/postgres.png", "3-Appboilers", "PostgreSQL is a powerful, open source object-relational database system. It has more than 15 years of active development and a proven architecture that has earned it a strong reputation for reliability, data integrity, and correctness. It runs on all major operating systems, including Linux, UNIX (AIX, BSD, HP-UX, SGI IRIX, Mac OS X, Solaris, Tru64), and Windows. It is fully ACID compliant, has full support for foreign keys, joins, views, triggers, and stored procedures (in multiple languages). It includes most SQL:2008 data types, including INTEGER, NUMERIC, BOOLEAN, CHAR, VARCHAR, DATE, INTERVAL, and TIMESTAMP. It also supports storage of binary large objects, including pictures, sounds, or video. "), MarketPlacePlans(List(new MarketPlacePlan("0", "Open source object-relational database system.", "Free", "9.1", "", "Ubuntu 13.04 +"))), "false", "predefnode", "true"),
    "8-Megam-AppBoilers-Riak" -> MarketPlaceInput("8-Megam-AppBoilers-Riak", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/riak.png", "3-Appboilers", "Riak is a <span class='label label-info'>distributed database</span> designed to deliver maximum data availability by <span class='label label-info'>distributing data across multiple servers</span>."), 
      MarketPlacePlans(List(new MarketPlacePlan("0", "The World’s Most Scalable Distributed Database is Now Just a Few Clicks Away.", "Free", "1.4.8", "https://s3-ap-southeast-1.amazonaws.com/megampub/marketplace/riak/riak_1.4.8-1_amd64.deb", "Ubuntu 13.04 +"), new MarketPlacePlan("0", "The World’s Most Scalable Distributed Database is Now Just a Few Clicks Away.", "Free", "2.0.beta1", "https://s3-ap-southeast-1.amazonaws.com/megampub/marketplace/riak/riak_2.0.0beta1-1_amd64.deb", "Ubuntu 13.04 +"))), "false", "predefnode", "true"),
    "9-Megam-AppBoilers-Redis" -> MarketPlaceInput("9-Megam-AppBoilers-Redis", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/redis.png", "3-Appboilers", "Redis is an open source, BSD licensed, advanced key-value store. It is often referred to as a data structure server since keys can contain strings, hashes, lists, sets and sorted sets."), MarketPlacePlans(List(new MarketPlacePlan("0", "most popular key-value store.", "Free", "2.8.6", "", "Ubuntu 13.04 +"))), "false", "predefnode", "true"),
    "10-Megam-AppBoilers-RabbitMQ" -> MarketPlaceInput("10-Megam-AppBoilers-RabbitMQ", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/rabbitmq.png", "3-Appboilers", "RabbitMQ is open source message broker software (sometimes called message-oriented middleware) that implements the Advanced Message Queuing Protocol (AMQP)."), MarketPlacePlans(List(new MarketPlacePlan("0", "Advanced Message Queuing Protocol .", "Free", "2.8.6", "", "Ubuntu 13.04 +"))), "false", "predefnode", "true")
      )
    /*"11-Alfresco" -> MarketPlaceInput("11-Alfresco",
      new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/alfresco.png",
        "ECM",
        "Alfresco Community Edition allows organizations to manage any type of content from simple office documents to scanned images, photographs, engineering drawings and large video files. It is commonly used as a: Document management system, Content platform, CMIS-compliant repository"),
        MarketPlacePlans(List(new MarketPlacePlan("0", "Alfresco Community Edition is the open source alternative for Enterprise Content Management. ", "Free", "4.2", "Work in progress.", "Ubuntu 13.04 +"))),
      "false", "predefnode", "false"),
    "12-Diaspora" -> MarketPlaceInput("12-Diaspora",
      new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/diaspora.png", "Social", ""),
      MarketPlacePlans(List(new MarketPlacePlan("0", "Diaspora foundation", "Free", "", "Work in progress.", "Ubuntu 13.04 +"))),
      "false", "predefnode", "false"),
    "13-DokuWiki" -> MarketPlaceInput("13-DokuWiki", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/dokuwiki.png", "Wiki", ""),
      MarketPlacePlans(List(new MarketPlacePlan("0", "DokuWiki is a popular choice when choosing a Wiki software", "Free", "", "Work in progress", "Ubuntu 13.04 +"))),
      "false", "predefnode", "false"),
    "14-DRBD" -> MarketPlaceInput("14-DRBD", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/drbd.png", "DR", "The Distributed Replicated Block Device (DRBD) is a distributed replicated storage system for the Linux platform."),
      MarketPlacePlans(List(new MarketPlacePlan("0", "Disaster recovery for your app/service", "Free", "8.4.4", "", "Ubuntu 13.04 +"))),
      "true", "predefnode", "true"),
    "15-DreamFactory" -> MarketPlaceInput("15-DreamFactory", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/dreamfactory.png", "Mobile", ""),
      MarketPlacePlans(List(new MarketPlacePlan("0", "Disaster recovery for your app/service", "Free", "8.4.3", "", "Ubuntu 13.04 +"))),
      "false", "predefnode", "false"),
    "16-Drupal" -> MarketPlaceInput("16-Drupal", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/drupal.png", "CMS", ""),
      MarketPlacePlans(List(new MarketPlacePlan("0", "Disaster recovery for your app/service", "Free", "8.4.3", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "17-Elgg" -> MarketPlaceInput("17-Elgg", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/elgg.png", "Social", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "18-Firepad" -> MarketPlaceInput("18-Firepad", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/firepad.png", "DevelopmentPlatform", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "19-Ghost" -> MarketPlaceInput("19-Ghost", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/ghost.png", "Blog", "Ghost is an Open Source application which allows you to write and publish your own blog, giving you the tools to make it easy and even fun to do."), MarketPlacePlans(List(new MarketPlacePlan("0", "Just a blogging platform", "Free", "0.4.1", "https://github.com/indykish/ghost.git", "Ubuntu 13.04 +"))), "false", "predefnode", "true"),
    "20-Gitlab" -> MarketPlaceInput("20-Gitlab", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/gitlab.png", "DevelopmentPlatform", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "21-Hadoop" -> MarketPlaceInput("21-Hadoop", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/hadoop.png", "BusinessIntelligence", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "22-Jenkins" -> MarketPlaceInput("22-Jenkins", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/jenkins.png", "DevelopmentPlatform", "Jenkins CI is the leading open-source continuous integration server. Built with Java, it provides atleast 800+ plugins to support building and testing virtually any project."),
      MarketPlacePlans(List(new MarketPlacePlan("0", "An extendable open source continuous integration server.", "Free", "1.558", "https://s3-ap-southeast-1.amazonaws.com/megampub/0.3/war/jenkins.war", "Ubuntu 13.04 +"))), "false", "predefnode", "true"),
    "23-Joomla" -> MarketPlaceInput("23-Joomla", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/joomla.png", "CMS", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "24-Liferay" -> MarketPlaceInput("24-Liferay", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/liferay.png", "Collaboration", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "25-Magneto" -> MarketPlaceInput("25-Magneto", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/magneto.png", "e-Commerce", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "26-MediaWiki" -> MarketPlaceInput("26-MediaWiki", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/mediawiki.png", "Wiki", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "27-OpenAM" -> MarketPlaceInput("27-OpenAM", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openam.png", "Identity", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "28-OpenAtrium" -> MarketPlaceInput("28-OpenAtrium", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openatrium.png", "ProjectManagement", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "29-OpenDJ" -> MarketPlaceInput("29-OpenDJ", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/opendj.png", "DirectoryServices", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "30-OpenERP" -> MarketPlaceInput("30-OpenERP", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openerp.png", "ERP", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "31-OpenLDAP" -> MarketPlaceInput("31-OpenLDAP", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openldap.png", "DirectoryServices", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "32-OTRS" -> MarketPlaceInput("32-OTRS", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/otrs.png", "HelpDesk", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "33-OwnCloud" -> MarketPlaceInput("33-OwnCloud", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/owncloud.png", "Collaboration", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "34-Redmine" -> MarketPlaceInput("34-Redmine", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/redmine.png", "ProjectManagement", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "35-ReviewBoard" -> MarketPlaceInput("35-ReviewBoard", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/reviewboard.png", "DevelopmentPlatform", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
   "36-SCMManager" -> MarketPlaceInput("36-SCMManager", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/scmmanager.png", "DevelopmentPlatform", "A NEW DIMENSION OF SOURCE CODE MANAGEMENT:</br>Enjoy the fascinating possibilities of secure and innovative source code management by using the open source software SCM-Manager.</br> SCM-Manager allows you to manage your source code repositories via an intuitive web interface. It unifies the management of Git, Subversion and Mercurial repositories and enables distributed development teams to administer user rights without having to deal with complex configuration files."),
      MarketPlacePlans(List(new MarketPlacePlan("0", "Easiest way to share and manage your Git repositories over http.", "Free", "1.36", "https://s3-ap-southeast-1.amazonaws.com/megampub/0.3/war/scmmanager.war", "Ubuntu 13.04 +"))), "false", "predefnode", "true"),
    "37-SugarCRM" -> MarketPlaceInput("37-SugarCRM", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/sugarcrm.png", "CRM", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "38-ThinkUp" -> MarketPlaceInput("38-ThinkUp", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/thinkup.png", "Social", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "39-Trac" -> MarketPlaceInput("39-Trac", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/trac.png", "BugTracking", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "40-TWiki" -> MarketPlaceInput("40-TWiki", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/twiki.png", "Wiki", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "41-WordPress" -> MarketPlaceInput("41-WordPress", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/wordpress.png", "CMS", "WordPress is web software you can use to create a beautiful website or blog. WordPress is both free and priceless at the same time. The core software is built by hundreds of community volunteers, and when you’re ready for more there are thousands of plugins and themes available to transform your site into almost anything you can imagine."), 
      MarketPlacePlans(List(new MarketPlacePlan("0", "WordPress - Launch your Blog in Cloud.", "Free", "3.8.1", "", "Ubuntu 13.04 +"))), "false", "predefnode", "true"),
    "42-XWiki" -> MarketPlaceInput("42-XWiki", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/xwiki.png", "Wiki", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
    "43-Zarafa" -> MarketPlaceInput("43-Zarafa", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/zarafa.png", "Email", "Zarafa is a collaboration platform that offers integration with existing mail clients and mobile devices. It also offers its own web-based client. The introduction of WebApp is a milestone for Zarafa because the browser-based collaboration client goes beyond Outlook. This next-generation client includes multi-user weekly calendaring and advanced delegation via the browser."), 
      MarketPlacePlans(List(new MarketPlacePlan("0", "The Best Open Source Email & Collaboration Software", "Free", "7.1.7", "https://s3-ap-southeast-1.amazonaws.com/megampub/marketplace/zarafa/zcp-7.1.9-44333-debian-7.0-x86_64.tar.gz", "Debian Wheezy 7.1"))), "false", "predefnode", "true"),
...
case class MarketPlaceResult(id: String, name: String, appdetails: MarketPlaceAppDetails, plans: MarketPlacePlans, attach: String, predefnode: String, approved: String, created_at: String) {
...
object MarketPlaces {
  ...
  private def mkGunnySack(email: String, input: String): ValidationNel[Throwable, Option[GunnySack]] = {
    ...
    for {
     ...
     // val json = new MarketPlaceResult(uir.get._1 + uir.get._2, mkp.name, mkp.appdetails, mkp.features, mkp.plans, mkp.applinks, mkp.attach, mkp.predefnode, mkp.approved, Time.now.toString).toJson(false)
      val json = new MarketPlaceResult(uir.get._1 + uir.get._2, mkp.name, mkp.appdetails, mkp.plans, mkp.attach, mkp.predefnode, mkp.approved, Time.now.toString).toJson(false)
  ...
  private def mkGunnySack_init(input: MarketPlaceInput): ValidationNel[Throwable, Option[GunnySack]] = {
    ...
    for {
      ...
      val bvalue = Set(mkp.name)
      val mkpJson = new MarketPlaceResult(uir.get._1 + uir.get._2, mkp.name, mkp.appdetails, mkp.plans, mkp.attach, mkp.predefnode, mkp.approved, Time.now.toString).toJson(false)
            ...
            flatMap { maybeGS: Option[GunnySack] =>
              maybeGS match {
                ...
                case None => {
                  ...
                  MarketPlaceResults(MarketPlaceResult(new String(), p._2.name, p._2.appdetails, p._2.plans, p._2.attach, p._2.predefnode, p._2.approved, new String())).successNel[Throwable]
                }
              }
            }
        }
