...
object MarketPlaceInput {
  ...
  val toMap = Map[String, MarketPlaceInput](
    "alfresco" -> MarketPlaceInput("alfresco", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/alfresco.png", "ECM", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 alfresco app", "free"), "false", "predefnode", "false"),
    "diaspora" -> MarketPlaceInput("diaspora", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/diaspora.png", "Social", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 diaspora app", "free"), "false", "predefnode", "false"),
    "dokuwiki" -> MarketPlaceInput("dokuwiki", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/dokuwiki.png", "Wiki", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 dokuwiki app", "free"), "false", "predefnode", "false"),
    ...
    "dreamfactory" -> MarketPlaceInput("dreamfactory", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/dreamfactory.png", "Mobile Development", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 dreamfactory app", "free"), "false", "predefnode", "false"),
    "drupal" -> MarketPlaceInput("drupal", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/drupal.png", "CMS", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 drupal app", "free"), "false", "predefnode", "false"),
    "elgg" -> MarketPlaceInput("elgg", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/elgg.png", "Social", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 elgg app", "free"), "false", "predefnode", "false"),
    "firepad" -> MarketPlaceInput("firepad", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/firepad.png", "Cloud Editor", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 firepad app", "free"), "false", "predefnode", "false"),
    "ghost" -> MarketPlaceInput("ghost", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/ghost.png", "Blog", "free", new MarketPlaceFeatures("Ghost is an Open Source application which allows you to write and publish your own blog, giving you the tools to make it easy and even fun to do. It's simple, elegant, and designed so that you can spend less time making your blog work and more time blogging.", "Never stop writing, format on the fly. No messing around with *buttons* everywhere. No writing repetitive HTML markup. Mobile friendly.", "Ghost grabs all the important data about your blog and pulls it into one place. No more clicking through tens of browser tabs to view your traffic, social media subscriptions, content performance or news feeds.", "You can write themes for it so your blog can have its own design. You can write plugins for it to add your own functionality. You can host it on your laptop, or you can host it on a public server. The code is open, and so is the MIT license. No restrictions."), new MarketPlacePlan("0", "create 1 ghost app", "free"), "true", "predefnode", "true"),
    "gitlab" -> MarketPlaceInput("gitlab", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/gitlab.png", "Continuous Integration", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 gitlab app", "free"), "false", "predefnode", "false"),
    "hadoop" -> MarketPlaceInput("hadoop", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/hadoop.png", "Business Intelligence", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 hadoop app", "free"), "false", "predefnode", "false"),
    ...
    "joomla" -> MarketPlaceInput("joomla", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/joomla.png", "CMS", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 joomla app", "free"), "false", "predefnode", "false"),
    "liferay" -> MarketPlaceInput("liferay", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/liferay.png", "Collaboration", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 liferay app", "free"), "false", "predefnode", "false"),
    "magneto" -> MarketPlaceInput("magneto", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/magneto.png", "e-Commerce", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 magneto app", "free"), "false", "predefnode", "false"),
    "mediawiki" -> MarketPlaceInput("mediawiki", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/mediawiki.png", "Wiki", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 mediawiki app", "free"), "false", "predefnode", "false"),
    "openam" -> MarketPlaceInput("openam", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openam.png", "AM", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 openam app", "free"), "false", "predefnode", "false"),
    "openatrium" -> MarketPlaceInput("openatrium", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openatrium.png", "Project Management", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 openatrium app", "free"), "false", "predefnode", "false"),
    "opendj" -> MarketPlaceInput("opendj", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/opendj.png", "AM", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 opendj app", "free"), "false", "predefnode", "false"),
    "openerp" -> MarketPlaceInput("openerp", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openerp.png", "ERP", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 openerp app", "free"), "false", "predefnode", "false"),
    "openldap" -> MarketPlaceInput("openldap", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openldap.png", "Directory Services", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 openldap app", "free"), "false", "predefnode", "false"),
    "otrs" -> MarketPlaceInput("otrs", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/otrs.png", "HelpDesk", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 otrs app", "free"), "false", "predefnode", "false"),
    "owncloud" -> MarketPlaceInput("owncloud", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/owncloud.png", "Media sharing", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 owncloud app", "free"), "false", "predefnode", "false"),
    "redmine" -> MarketPlaceInput("redmine", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/redmine.png", "Collaboration", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 redmine app", "free"), "false", "predefnode", "false"),
    "reviewboard" -> MarketPlaceInput("reviewboard", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/reviewboard.png", "Collaboration", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 reviewboard app", "free"), "false", "predefnode", "false"),
    ...
    "sugarcrm" -> MarketPlaceInput("sugarcrm", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/sugarcrm.png", "CRM", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 sugarcrm app", "free"), "false", "predefnode", "false"),
    "thinkup" -> MarketPlaceInput("thinkup", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/thinkup.png", "Social", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 thinkup app", "free"), "false", "predefnode", "false"),
    "trac" -> MarketPlaceInput("trac", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/trac.png", "Bug Tracking", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 trac app", "free"), "false", "predefnode", "false"),
    "twiki" -> MarketPlaceInput("twiki", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/twiki.png", "Wiki", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 twiki app", "free"), "false", "predefnode", "false"),
    ...
    "xwiki" -> MarketPlaceInput("xwiki", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/xwiki.png", "Wiki", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 xwiki app", "free"), "false", "predefnode", "false"),
    "zarafa" -> MarketPlaceInput("zarafa", "https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/zarafa.png", "Firewall", "free", new MarketPlaceFeatures("feature1", "feature2", "feature3", "feature4"), new MarketPlacePlan("0", "Create 1 zarafa app", "free"), "false", "predefnode", "false")
  )
