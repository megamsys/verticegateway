...
case class MarketPlacePlan(price: String, description: String, plantype: String, version: String, source: String) {
...
object MarketPlacePlan {
  def empty: MarketPlacePlan = new MarketPlacePlan(new String(), new String(), new String(), new String, new String())
...
object MarketPlaceInput {
  ...
  val toMap = Map[String, MarketPlaceInput](
    "10-Alfresco" -> MarketPlaceInput("10-Alfresco", 
        ...
        MarketPlacePlans(List(new MarketPlacePlan("0", "Alfresco community edition", "free","4.2", "Work in progress."))), 
    ...
    "11-Diaspora" -> MarketPlaceInput("11-Diaspora", 
        ...
        MarketPlacePlans(List(new MarketPlacePlan("0", "Diaspora foundation", "free","","Work in progress."))), 
        new MarketPlaceAppLinks("", "", "", "", "", "", ""), "false", "predefnode", "false"),
   "12-DokuWiki" -> MarketPlaceInput("12-DokuWiki", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/dokuwiki.png", "Wiki",""),  
       ...
       MarketPlacePlans(List(new MarketPlacePlan("0", "DokuWiki is a popular choice when choosing a Wiki software", "free","","Work in progress"))), 
       new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "1-DRBD" -> MarketPlaceInput("1-DRBD", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/drbd.png", "DR", "The Distributed Replicated Block Device (DRBD) is a distributed replicated storage system for the Linux platform."),  
        new MarketPlaceFeatures("Backup your drive to any cloud, simply provide a directory (/var/lib/data).", "Enhances your app/server to be highly available, load balanced on multi cloud.", "Long-distance replication with DRBD Proxy (paid product).", "Launch new apps/services which are highly available."), 
        MarketPlacePlans(List(new MarketPlacePlan("0", "Disaster recovery for your app/service", "free","8.4.3",""))),
        new MarketPlaceAppLinks("", "http://www.linbit.com/en/products-and-services/drbd-support/pricing/pricing-euro", "http://www.drbd.org/", "http://www.drbd.org/home/what-is-drbd/", "http://www.drbd.org/docs/about/", "http://www.drbd.org/users-guide-9.0/", "http://git.drbd.org/"), "true", "predefnode", "true"),
    ...
    "14-Drupal" -> MarketPlaceInput("14-Drupal", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/drupal.png", "CMS", ""), 
        new MarketPlaceFeatures("", "", "", ""),
        MarketPlacePlans(List(new MarketPlacePlan("0", "Disaster recovery for your app/service", "free","8.4.3",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "15-Elgg" -> MarketPlaceInput("15-Elgg", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/elgg.png", "Social", ""),  new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "16-Firepad" -> MarketPlaceInput("16-Firepad", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/firepad.png", "DevelopmentPlatform", ""),  new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "2-Ghost" -> MarketPlaceInput("2-Ghost", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/ghost.png", "Blog", "Ghost is an Open Source application which allows you to write and publish your own blog, giving you the tools to make it easy and even fun to do."), new MarketPlaceFeatures("Ghost has an incredibly simple concept for writing. You write in Markdown on the left, and you see an immediate preview of exactly what your post will look like in rendered HTML on the right", "The Ghost Open Marketplace contains a large directory of themes, apps, and resources which have been created for Ghost.", "Drag and drop the widgets to create your own custom dashboard, with the most important information first.",""), MarketPlacePlans(List(new MarketPlacePlan("0", "Blogging platform", "free","0.4.1","https://github.com/indykish/ghost.git"))), new MarketPlaceAppLinks("https://ghost.org/forum/", "#", "https://ghost.org/", "https://ghost.org/features/", "https://ghost.org/about/", "http://en.wikipedia.org/wiki/Ghost_(blogging_platform)", "https://github.com/tryghost/Ghost"), "false", "predefnode", "true"),
    "17-Gitlab" -> MarketPlaceInput("17-Gitlab", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/gitlab.png", "DevelopmentPlatform", ""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "18-Hadoop" -> MarketPlaceInput("18-Hadoop", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/hadoop.png", "BusinessIntelligence", ""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "3-Jenkins" -> MarketPlaceInput("3-Jenkins", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/jenkins.png", "DevelopmentPlatform", "Jenkins CI is the leading open-source continuous integration server. Built with Java, it provides atleast 800+ plugins to support building and testing virtually any project."), 
        ...
        MarketPlacePlans(List(new MarketPlacePlan("0", "Continious Integration Engine", "free","1.554","http://mirrors.jenkins-ci.org/war/latest/jenkins.war"))), new MarketPlaceAppLinks("https://groups.google.com/forum/#!forum/jenkinsci-users", "#", "http://jenkins-ci.org/", "http://jenkins-ci.org/node", "http://jenkins-ci.org/node", "https://wiki.jenkins-ci.org/display/JENKINS/Home", "https://github.com/jenkinsci/jenkins"), "false", "predefnode", "true"),
    "19-Joomla" -> MarketPlaceInput("19-Joomla", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/joomla.png", "CMS", ""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "20-Liferay" -> MarketPlaceInput("20-Liferay", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/liferay.png", "Collaboration", ""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "21-Magneto" -> MarketPlaceInput("21-Magneto", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/magneto.png", "e-Commerce",""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "22-MediaWiki" -> MarketPlaceInput("22-MediaWiki", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/mediawiki.png", "Wiki", ""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "23-OpenAM" -> MarketPlaceInput("23-OpenAM", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openam.png", "Identity", ""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "24-OpenAtrium" -> MarketPlaceInput("24-OpenAtrium", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openatrium.png", "ProjectManagement", ""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "25-OpenDJ" -> MarketPlaceInput("25-OpenDJ", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/opendj.png", "DirectoryServices", ""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "26-OpenERP" -> MarketPlaceInput("26-OpenERP", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openerp.png", "ERP", ""),  new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "27-OpenLDAP" -> MarketPlaceInput("27-OpenLDAP", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openldap.png", "DirectoryServices", ""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "28-OTRS" -> MarketPlaceInput("28-OTRS", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/otrs.png", "HelpDesk", ""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "29-OwnCloud" -> MarketPlaceInput("29-OwnCloud", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/owncloud.png", "Collaboration", ""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "30-Redmine" -> MarketPlaceInput("30-Redmine", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/redmine.png", "ProjectManagement", ""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "31-ReviewBoard" -> MarketPlaceInput("31-ReviewBoard", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/reviewboard.png", "DevelopmentPlatform", ""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "4-Riak" -> MarketPlaceInput("4-Riak", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/riak.png", "DB", "Riak is a <span class='label label-info'>distributed database</span> designed to deliver maximum data availability by <span class='label label-info'>distributing data across multiple servers</span>."), new MarketPlaceFeatures("Riak replicates and retrieves data intelligently so it is available for read and write operations, even in failure conditions. You can lose access to many nodes due to network partition or hardware failure without losing data. Add new machines to your Riak cluster easily without incurring a larger operational burden – the same ops tasks apply to small clusters as large clusters.", "Riak automatically distributes data around the cluster and yields a near-linear performance increase as you add capacity. Use Riak’s distributed, full-text search engine with a robust query language. Tag objects stored in Riak with additional values and query by exact match or range.", "Non-key-based querying for large datasets.Data is distributed across nodes using consistent hashing. Consistent hashing ensures data is evenly distributed around the cluster and new nodes can be added automatically, with minimal reshuffling. Riak uses Folsom, an Erlang-based system that collects and reports real-time metrics, to provide stats via HTTP request.", ""), 
        MarketPlacePlans(List(new MarketPlacePlan("0", "Scalable NOSQL Database", "free","2.0.0p20",""))), new MarketPlaceAppLinks("http://docs.basho.com/riak/latest/community/", "http://basho.com/contact/", "http://basho.com/riak/", "http://docs.basho.com/", "http://basho.com/", "http://en.wikipedia.org/wiki/Riak", "https://github.com/basho/riak"), "false", "predefnode", "true"),
    "5-SCMManager" -> MarketPlaceInput("5-SCMManager", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/scmmanager.png", "DevelopmentPlatform", "The easiest way to share and manage your <span class='label label-info'>Git, Mercurial and Subversion</span> repositories over http"), 
        ...
        MarketPlacePlans(List(new MarketPlacePlan("0", "SCM Manager - Git repo over http", "free","1.36","https://s3-ap-southeast-1.amazonaws.com/megampub/0.1/war/scmmanager.war"))), new MarketPlaceAppLinks("https://groups.google.com/forum/#!forum/scmmanager", "https://www.scm-manager.com/support/", "https://www.scm-manager.com/", "https://www.scm-manager.com/scm-manager/", "http://www.scm-manager.org/", "https://bitbucket.org/sdorra/scm-manager/wiki/Home", "https://bitbucket.org/sdorra/scm-manager/src"), "false", "predefnode", "true"),
    "32-SugarCRM" -> MarketPlaceInput("32-SugarCRM", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/sugarcrm.png", "CRM", ""),  new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "33-ThinkUp" -> MarketPlaceInput("33-ThinkUp", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/thinkup.png", "Social", ""),  new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "34-Trac" -> MarketPlaceInput("34-Trac", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/trac.png", "BugTracking", ""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "35-TWiki" -> MarketPlaceInput("35-TWiki", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/twiki.png", "Wiki", ""),  new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "6-WordPress" -> MarketPlaceInput("6-WordPress", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/wordpress.png", "CMS", "WordPress is web software you can use to create a beautiful <strong><em>website or blog</em></strong>. WordPress is both free and priceless at the same time."),  new MarketPlaceFeatures("Start a blog or build a full-fledged website. The only limit is your imagination. Build a great site and spend nothing, zilch, nada. And if you want to make a great site even better, a great selection of premium upgrades. Share your work with the world.", "Publicize lets you connect your WordPress site to the most popular social networks — Facebook, Twitter, Tumblr, LinkedIn, and more. Learn more about your readers, where they’re from, and how they found you. Maps and graphs that beautifully present your stats. Don’t be confined to the desk. Publish near and far with mobile apps for iPhone, iPad, Android, and BlackBerry.", "Your site is hosted on cloud across multiple data centers. That way, it’s super fast and always available. Wordpress dashboard is available in over 50 languages and counting.", "Whether you’re searching the forums, reading the support pages, you can always find a helping hand. Keep track of all your favorite blogs and discover new ones with the Reader."), 
        MarketPlacePlans(List(new MarketPlacePlan("0", "Widely used CMS", "free", "3.8.1",""))), new MarketPlaceAppLinks("http://wordpress.org/support/", "#", "http://wordpress.org/", "http://codex.wordpress.org/Main_Page", "http://wordpress.com/", "http://en.wikipedia.org/wiki/WordPress", "https://github.com/WordPress/WordPress"), "false", "predefnode", "true"),
    "36-XWiki" -> MarketPlaceInput("36-XWiki", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/xwiki.png", "Wiki", ""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "37-Zarafa" -> MarketPlaceInput("37-Zarafa", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/zarafa.png", "Email", ""), new MarketPlaceFeatures("", "", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "", "free","",""))), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
    "7-PostgreSQL" -> MarketPlaceInput("7-PostgreSQL", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/postgres.png", "DB", ""), new MarketPlaceFeatures("Our software has been designed and created to have much lower maintenance and tuning requirements than the leading proprietary databases, yet still retain all of the features, stability, and performance.In addition to this, our training programs are generally regarded as being far more cost effective, manageable, and practical in the real world than that of the leading proprietary database vendors.", "We use a multiple row data storage strategy called MVCC to make PostgreSQL extremely responsive in high volume environments.  The leading proprietary database vendor uses this technology as well, for the same reasons.", "There are many high-quality GUI Tools available for PostgreSQL from both open source developers and commercial providers.", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "PostgreSQL Database", "free","9.3",""))), new MarketPlaceAppLinks("http://www.postgresql.org/support/", "#", "http://www.postgresql.org/", "http://www.postgresql.org/docs/", "http://www.postgresql.org/docs/manuals/", "https://wiki.postgresql.org/wiki/Main_Page", "http://www.postgresql.org/ftp/source/"), "false", "predefnode", "true"), 
    "8-Redis" -> MarketPlaceInput("8-Redis", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/redis.png", "DB", ""), new MarketPlaceFeatures("Redis is an open source, BSD licensed, advanced key-value store. It is often referred to as a data structure server since keys can contain strings, hashes, Lists, sets and sorted sets.You can run atomic operations on these types, like appending to a string; incrementing the value in a hash; pushing to a List; computing set intersection, union and difference; or getting the member with highest ranking in a sorted set.", "In order to achieve its outstanding performance, Redis works with an in-memory dataset. Depending on your use case, you can persist it either by dumping the dataset to disk every once in a while, or by appending each command to a log. Redis also supports trivial-to-setup master-slave replication, with very fast non-blocking first synchronization, auto-reconnection on net split and so forth.", "", ""), MarketPlacePlans(List(new MarketPlacePlan("0", "Redis Key Value Store", "free","2.8.8",""))), new MarketPlaceAppLinks("http://redis.io/support", "#", "http://redis.io/", "http://redis.io/documentation", "http://docs.cloudno.de/redis", "http://en.wikipedia.org/wiki/Redis", "https://github.com/antirez/redis"), "false", "predefnode", "true"), 
    "9-Op5" -> MarketPlaceInput("9-Op5", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/op5.png", "Monitor",""),  new MarketPlaceFeatures("op5 Monitor allows you to easily monitor all kinds of servers and provide alerting, reporting and visualization. op5 Monitor can monitor physical, virtual, cloud and hybrid types of server environments as well as all layers needed to ensure high quality of services.", "op5 Monitor was specifically designed to be a flexible and scalable solution able to handle very large volumes of monitored devices and checks, as well as being optimized to achieve very low per-device overheads. op5 Monitor can handle distributed monitoring, load sharing and scale to several thousands of op5 Monitor Peers with automatic failover from pollers.", "op5 Monitor presents detailed information about the performance of thousands of devices and interfaces in your network. From a single user interface, you can drill down into any element on your network to see exactly what’s happening.", "op5 Monitor includes BSM functionality that enables managing, monitoring and measuring information technology as it relates to an organization’s business processes."), 
        MarketPlacePlans(List(new MarketPlacePlan("0", "Op5 Monitor for your Enterprise (60 day trial)", "Paid","6.2.1","https://s3-ap-southeast-1.amazonaws.com/megampub/0.3/op5/op5-monitor-6.2.1.tar.gz"), 
        new MarketPlacePlan("0", "Op5 Monitor for your Enterprise", "Free","6.3Beta","https://s3-ap-southeast-1.amazonaws.com/megampub/0.3/op5/op5-monitor-6.2.1.tar.gz"))), 
        new MarketPlaceAppLinks("https://www.op5.com/support/", "#", "https://www.op5.com/", "https://www.op5.com/explore-op5-monitor/", "http://www.postgresql.org/docs/manuals/", "http://en.wikipedia.org/wiki/Op5_Monitor", "https://kb.op5.com/display/COMMUNITY/Community+Home"), "false", "predefnode", "true")) 
