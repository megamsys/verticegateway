...
object MarketPlaceInput {
 ...
 "9-Alfresco" -> MarketPlaceInput("9-Alfresco", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/alfresco.png", "ECM", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 alfresco app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"10-Diaspora" -> MarketPlaceInput("10-Diaspora", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/diaspora.png", "Social", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 diaspora app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"11-DokuWiki" -> MarketPlaceInput("11-DokuWiki", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/dokuwiki.png", "Wiki", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 dokuwiki app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
...
"12-DreamFactory" -> MarketPlaceInput("12-DreamFactory", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/dreamfactory.png", "Mobile", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 dreamfactory app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"13-Drupal" -> MarketPlaceInput("13-Drupal", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/drupal.png", "CMS", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 drupal app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"14-Elgg" -> MarketPlaceInput("14-Elgg", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/elgg.png", "Social", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 elgg app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"15-Firepad" -> MarketPlaceInput("15-Firepad", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/firepad.png", "DevelopmentPlatform", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 firepad app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
...
"16-Gitlab" -> MarketPlaceInput("16-Gitlab", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/gitlab.png", "DevelopmentPlatform", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 gitlab app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"17-Hadoop" -> MarketPlaceInput("17-Hadoop", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/hadoop.png", "BusinessIntelligence", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 hadoop app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
...
"18-Joomla" -> MarketPlaceInput("18-Joomla", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/joomla.png", "CMS", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 joomla app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"19-Liferay" -> MarketPlaceInput("19-Liferay", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/liferay.png", "Collaboration", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 liferay app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"20-Magneto" -> MarketPlaceInput("20-Magneto", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/magneto.png", "e-Commerce", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 magneto app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"21-MediaWiki" -> MarketPlaceInput("21-MediaWiki", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/mediawiki.png", "Wiki", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 mediawiki app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"22-OpenAM" -> MarketPlaceInput("22-OpenAM", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openam.png", "Identity", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 openam app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"23-OpenAtrium" -> MarketPlaceInput("23-OpenAtrium", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openatrium.png", "ProjectManagement", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 openatrium app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"24-OpenDJ" -> MarketPlaceInput("24-OpenDJ", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/opendj.png", "DirectoryServices", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 opendj app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"25-OpenERP" -> MarketPlaceInput("25-OpenERP", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openerp.png", "ERP", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 openerp app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"26-OpenLDAP" -> MarketPlaceInput("26-OpenLDAP", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/openldap.png", "DirectoryServices", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 openldap app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"27-OTRS" -> MarketPlaceInput("27-OTRS", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/otrs.png", "HelpDesk", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 otrs app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"28-OwnCloud" -> MarketPlaceInput("28-OwnCloud", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/owncloud.png", "Collaboration", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 owncloud app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"29-Redmine" -> MarketPlaceInput("29-Redmine", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/redmine.png", "ProjectManagement", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 redmine app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"30-ReviewBoard" -> MarketPlaceInput("30-ReviewBoard", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/reviewboard.png", "DevelopmentPlatform", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 reviewboard app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"4-Riak" -> MarketPlaceInput("4-Riak", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/riak.png", "DB", "2.0.0", "Riak is a <span class='label label-info'>distributed database</span> designed to deliver maximum data availability by <span class='label label-info'>distributing data across multiple servers</span>."), "free", new MarketPlaceFeatures("Riak replicates and retrieves data intelligently so it is available for read and write operations, even in failure conditions. You can lose access to many nodes due to network partition or hardware failure without losing data. Add new machines to your Riak cluster easily without incurring a larger operational burden – the same ops tasks apply to small clusters as large clusters.", "Riak automatically distributes data around the cluster and yields a near-linear performance increase as you add capacity. Use Riak’s distributed, full-text search engine with a robust query language. Tag objects stored in Riak with additional values and query by exact match or range.", "Non-key-based querying for large datasets.Data is distributed across nodes using consistent hashing. Consistent hashing ensures data is evenly distributed around the cluster and new nodes can be added automatically, with minimal reshuffling. Riak uses Folsom, an Erlang-based system that collects and reports real-time metrics, to provide stats via HTTP request.", ""), new MarketPlacePlan("0", "Create 1 database", "free"), new MarketPlaceAppLinks("http://docs.basho.com/riak/latest/community/", "http://basho.com/contact/", "http://basho.com/riak/", "http://docs.basho.com/", "http://basho.com/", "http://en.wikipedia.org/wiki/Riak", "https://github.com/basho/riak"), "false", "predefnode", "true"),
...
"31-SugarCRM" -> MarketPlaceInput("31-SugarCRM", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/sugarcrm.png", "CRM", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 sugarcrm app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"32-ThinkUp" -> MarketPlaceInput("32-ThinkUp", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/thinkup.png", "Social", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 thinkup app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"33-Trac" -> MarketPlaceInput("33-Trac", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/trac.png", "BugTracking", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 trac app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
"34-TWiki" -> MarketPlaceInput("34-TWiki", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/twiki.png", "Wiki", "0", ""), "free", new MarketPlaceFeatures("", "", "", ""), new MarketPlacePlan("0", "Create 1 twiki app", "free"), new MarketPlaceAppLinks("#", "#", "#", "#", "#", "#", "#"), "false", "predefnode", "false"),
