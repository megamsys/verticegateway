...
*/
   ...
   val toMap = Map[String, MarketPlaceInput](
"1-Megam-StarterPack-Java" -> MarketPlaceInput("1-Megam-StarterPack-Java", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/java.png", "1-Starter packs", "Object-oriented programming language"), MarketPlacePlans(List(new MarketPlacePlan("0", "Java is a computer programming language that is concurrent, class-based, object-oriented, and specifically designed to have as few implementation dependencies as possible.", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
"2-Megam-StarterPack-Rails" -> MarketPlaceInput("2-Megam-StarterPack-Rails", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/rails.png", "1-Starter packs", "Open source web application framework"), MarketPlacePlans(List(new MarketPlacePlan("0", "Ruby on Rails, or simply Rails, is an open source web application framework written in Ruby. Rails is a full-stack framework that emphasizes the use of well-known software engineering patterns and paradigms, including convention over configuration (CoC), don't repeat yourself (DRY), the active record pattern, and model–view–controller (MVC).", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
"3-Megam-StarterPack-Play" -> MarketPlaceInput("3-Megam-StarterPack-Play", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/play.png", "1-Starter packs", "Open-source toolkit"), MarketPlacePlans(List(new MarketPlacePlan("0", "Play is an open source web application framework, written in Scala and Java, which follows the model–view–controller (MVC) architectural pattern.", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
"4-Megam-StarterPack-Akka" -> MarketPlaceInput("4-Megam-StarterPack-Akka", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/akka.png", "1-Starter packs", "Open-source toolkit"), MarketPlacePlans(List(new MarketPlacePlan("0", "Akka is an open-source toolkit and runtime simplifying the construction of concurrent and distributed applications on the JVM. Akka supports multiple programming models for concurrency, but it emphasizes actor-based concurrency, with inspiration drawn from Erlang.", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
"5-Megam-StarterPack-Nodejs" -> MarketPlaceInput("5-Megam-StarterPack-Nodejs", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/nodejs.png", "1-Starter packs", "Cross-platform runtime environment"), MarketPlacePlans(List(new MarketPlacePlan("0", "Node.js is a cross-platform runtime environment for server-side and networking applications. Node.js applications are written in JavaScript, and can be run within the Node.js runtime on OS X, Microsoft Windows and Linux with no changes.", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
"6-Megam-platform-Docker" -> MarketPlaceInput("6-Megam-platform-Docker", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/docker.png", "2-Platform", "Virtual container"), MarketPlacePlans(List(new MarketPlacePlan("0", "Docker is an open-source project that automates the deployment of applications inside software containers, by providing an additional layer of abstraction and automation of operating system–level virtualization on Linux.", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
"7-Megam-StarterPack-Java" -> MarketPlaceInput("7-Megam-StarterPack-Java", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/java.png", "3-Runtime", "Object-oriented programming language"), MarketPlacePlans(List(new MarketPlacePlan("0", "Java is a computer programming language that is concurrent, class-based, object-oriented, and specifically designed to have as few implementation dependencies as possible.", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
"8-Megam-StarterPack-Rails" -> MarketPlaceInput("8-Megam-StarterPack-Rails", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/rails.png", "3-Runtime", "Open source web application framework"), MarketPlacePlans(List(new MarketPlacePlan("0", "Ruby on Rails, or simply Rails, is an open source web application framework written in Ruby. Rails is a full-stack framework that emphasizes the use of well-known software engineering patterns and paradigms, including convention over configuration (CoC), don't repeat yourself (DRY), the active record pattern, and model–view–controller (MVC).", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
"9-Megam-StarterPack-Play" -> MarketPlaceInput("9-Megam-StarterPack-Play", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/play.png", "3-Runtime", "Open-source toolkit"), MarketPlacePlans(List(new MarketPlacePlan("0", "Play is an open source web application framework, written in Scala and Java, which follows the model–view–controller (MVC) architectural pattern.", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
"10-Megam-StarterPack-Akka" -> MarketPlaceInput("10-Megam-StarterPack-Akka", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/akka.png", "3-Runtime", "Open-source toolkit"), MarketPlacePlans(List(new MarketPlacePlan("0", "Akka is an open-source toolkit and runtime simplifying the construction of concurrent and distributed applications on the JVM. Akka supports multiple programming models for concurrency, but it emphasizes actor-based concurrency, with inspiration drawn from Erlang.", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
"11-Megam-StarterPack-Nodejs" -> MarketPlaceInput("11-Megam-StarterPack-Nodejs", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/nodejs.png", "3-Runtime", "Cross-platform runtime environment"), MarketPlacePlans(List(new MarketPlacePlan("0", "Node.js is a cross-platform runtime environment for server-side and networking applications. Node.js applications are written in JavaScript, and can be run within the Node.js runtime on OS X, Microsoft Windows and Linux with no changes.", "Free", "", "", "Ubuntu 13.04 +"))), "false", "predefnode", "false"),
"12-Megam-AppBoilers-PostgreSQL" -> MarketPlaceInput("12-Megam-AppBoilers-PostgreSQL", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/postgres.png", "4-App Boilers", "Open source object-relational database system"), MarketPlacePlans(List(new MarketPlacePlan("0", "PostgreSQL is a powerful, open source object-relational database system. It has more than 15 years of active development and a proven architecture that has earned it a strong reputation for reliability, data integrity, and correctness. It runs on all major operating systems, including Linux, UNIX (AIX, BSD, HP-UX, SGI IRIX, Mac OS X, Solaris, Tru64), and Windows. It is fully ACID compliant, has full support for foreign keys, joins, views, triggers, and stored procedures (in multiple languages). It includes most SQL:2008 data types, including INTEGER, NUMERIC, BOOLEAN, CHAR, VARCHAR, DATE, INTERVAL, and TIMESTAMP. It also supports storage of binary large objects, including pictures, sounds, or video.", "Free", "9.1", "", "Ubuntu 13.04 +"))), "false", "predefnode", "true"),
"13-Megam-AppBoilers-Riak" -> MarketPlaceInput("13-Megam-AppBoilers-Riak", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/riak.png", "4-App Boilers", "Scalable Distributed Database"),
MarketPlacePlans(List(new MarketPlacePlan("0", "Riak is a distributed database designed to deliver maximum data availability by distributing data across multiple servers.", "Free", "1.4.8", "https://s3-ap-southeast-1.amazonaws.com/megampub/marketplace/riak/riak_1.4.8-1_amd64.deb", "Ubuntu 13.04 +"), new MarketPlacePlan("0", "Riak is a distributed database designed to deliver maximum data availability by distributing data across multiple servers.", "Free", "2.0.beta1", "https://s3-ap-southeast-1.amazonaws.com/megampub/marketplace/riak/riak_2.0.0beta1-1_amd64.deb", "Ubuntu 13.04 +"))), "false", "predefnode", "true"),
"14-Megam-AppBoilers-Redis" -> MarketPlaceInput("14-Megam-AppBoilers-Redis", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/redis.png", "4-App Boilers", "Most popular key-value store"), MarketPlacePlans(List(new MarketPlacePlan("0", "Redis is an open source, BSD licensed, advanced key-value store. It is often referred to as a data structure server since keys can contain strings, hashes, lists, sets and sorted sets.", "Free", "2.8.6", "", "Ubuntu 13.04 +"))), "false", "predefnode", "true"),
"15-Megam-AppBoilers-RabbitMQ" -> MarketPlaceInput("15-Megam-AppBoilers-RabbitMQ", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/rabbitmq.png", "4-App Boilers", "Advanced Message Queuing Protocol"), MarketPlacePlans(List(new MarketPlacePlan("0", "RabbitMQ is open source message broker software (sometimes called message-oriented middleware) that implements the Advanced Message Queuing Protocol (AMQP).", "Free", "2.8.6", "", "Ubuntu 13.04 +"))), "false", "predefnode", "true")
)
