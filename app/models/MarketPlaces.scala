...
"10-Megam-AppBoilers-Redis" -> MarketPlaceInput("10-Megam-AppBoilers-Redis", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/redis.png", "4-App Boilers", "Key Value Store"), MarketPlacePlans(List(new MarketPlacePlan("0", "Redis is a key-value store which acts as a data structure server with keys containing strings, hashes, lists, sets and sorted sets.", "Free", "2.8.4", "", "Ubuntu 14.04 +"))), "false", "predefnode", "true"),
"11-Megam-AppBoilers-RabbitMQ" -> MarketPlaceInput("11-Megam-AppBoilers-RabbitMQ", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/rabbitmq.png", "4-App Boilers", "Message Broker"), MarketPlacePlans(List(new MarketPlacePlan("0", "RabbitMQ is a message broker software  that implements the Advanced Message Queuing Protocol (AMQP).", "Free", "3.3.5", "", "Ubuntu 14.04 +"))), "false", "predefnode", "true"),
"12-Megam-Analytics-Hadoop" -> MarketPlaceInput("12-Megam-Analytics-Hadoop", new MarketPlaceAppDetails("https://s3-ap-southeast-1.amazonaws.com/megampub/images/market_place_images/hadoop.png", "5-Analytics", "Plumbing your big data is easy"), MarketPlacePlans(List(new MarketPlacePlan("0", "Apache Hadoop is a set of algorithms (an open-source software framework) for distributed storage and distributed processing of very large data sets (Big Data) on computer clusters built from commodity hardware", "Free", "2.6.0", "", "Ubuntu 14.04 +"))), "false", "predefnode", "true")
)
