...
import models.billing.{ SubscriptionsResult }

/**
 * @author rajthilak
 *
 */
class SubscriptionsResultSerialization(charset: Charset = UTF8Charset) extends SerializationBase[SubscriptionsResult] {
