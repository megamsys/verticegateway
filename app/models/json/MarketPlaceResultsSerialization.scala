 ...
 *
 */
object MarketPlaceResultsSerialization extends SerializationBase[MarketPlaceResults] {
  ...
  implicit override val reader = new JSONR[MarketPlaceResults] {
    override def read(json: JValue): Result[MarketPlaceResults] = {
      json match {
        ...
        case j => UnexpectedJSONError(j, classOf[JArray]).failNel[MarketPlaceResults]
      }
    }
  }
}
